...
exports.default = (function (_a) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4, Activity.find({}, { __v: false }).populate('createdBy', { password: false, __v: false, createdAt: false, updatedAt: false }).sort({ createdAt: 'desc' })];
                        case 1:
                            activities = _a.sent();
                            return [2, activities];
                        case 2:
    ...
    }((0, serviceGenerator_service_1.default)({ Model: Activity })));
});
